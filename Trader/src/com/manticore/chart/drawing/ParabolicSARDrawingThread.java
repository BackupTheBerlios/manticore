...
public class ParabolicSARDrawingThread extends DrawingThread {

    public ParabolicSARDrawingThread(ChartCanvas canvas, CandleArrayList candleVector) {
    ...
    public void run() {
        ...
        for (int i = 0; i < candleArrayList.size(); i++) {
            Double indicatorValue = candleArrayList.get(i).getParabolicSAR();
